package com.ecopilot.user.kafka.config;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, ProjectEvent> consumerFactory() {
        ...
        config.put(JsonDeserializer.TRUSTED_PACKAGES, "com.ecopilot.user.kafka.event,com.ecopilot.project.kafka.event");
        config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, ProjectEvent.class.getName());
